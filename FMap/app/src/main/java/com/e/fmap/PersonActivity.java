...
public class PersonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        personSelected = Model.getInstance().getPersonById(selectedPersonID);
        ...
        List<ModelEvents> eventsOfPerson = Model.getInstance().getEventsOfPersonByPersonId(selectedPersonID);
        ModelPersons person = Model.getInstance().getPersonById(selectedPersonID);
...
//Beginning people
        ...
        Map<String, List<ModelPersons>> childrenMap = Model.getInstance().getChildrenMap();
        if (childrenMap.containsKey(person.getPersonID())){ //person has children
            personsChildren = childrenMap.get(person.getPersonID());
        }

        personsParents = Model.getInstance().findParentsByPersonID(person);

        spouse = Model.getInstance().findSpouseByPersonID(person);
