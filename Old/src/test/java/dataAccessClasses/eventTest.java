...
/*
    ...
    public void removeEventByIdTest() throws DatabaseException {
        ...
        assertNull(tempDao.findEventById("event_id_01").getEventID(), "Was not removed");
    }
    ...
    public void removeEventsByIdsTest() throws DatabaseException {
        ...
        assertNull(tempDao.findEventById("event_id_01").getEventID(), "01 was not removed");
        assertNull(tempDao.findEventById("event_id_02").getEventID(), "02 was not removed");
    }
