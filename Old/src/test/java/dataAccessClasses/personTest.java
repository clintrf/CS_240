...
public class personTest {
    ...
    public void removePersonByIdTest() throws DatabaseException {
        ...
        assertNull(tempDao.findPersonById("person_id_01").getPersonID(), "Was not removed");
    }
    ...
    public void removePeopleByIds() throws DatabaseException {
        ...
        assertNull(tempDao.findPersonById("person_id_01").getPersonID(), "01 was not removed");
        assertNull(tempDao.findPersonById("person_id_02").getPersonID(), "02 was not removed");
    }
